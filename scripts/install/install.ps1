# Scripts to install Fast 1.0.0
$zipBase = "aHR0cHM6Ly9naXRodWIuY29tL2pld2Vsc2hram9ueS9mYXN0LWNsaS9yZWxlYXNlcy9kb3dubG9hZC8xLjAuMC93aW4uemlw"
...
Write-Output "Fast-1.0.0 has been successfully installed."
